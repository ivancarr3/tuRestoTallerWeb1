INSERT INTO
    usuario (email, password, rol, activo, confirmationToken)
VALUES
    ('admin@admin.com', 'admin', 'ADMIN', TRUE, '');

SET
    @idUsuario1 = LAST_INSERT_ID();

INSERT INTO
    usuario (email, password, rol, activo, confirmationToken)
VALUES
    ('user@user.com', 'user', 'USER', TRUE, '');

SET
    @idUsuario2 = LAST_INSERT_ID();
