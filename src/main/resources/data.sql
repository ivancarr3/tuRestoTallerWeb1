...
INSERT INTO restaurante (nombre, estrellas, direccion, imagen, capacidadMaxima) VALUES
    ('El club de la Milanesa', 5.0, 'Arieta 5000', 'restaurant.jpg', 2);
SET @idResto1 = LAST_INSERT_ID();

INSERT INTO restaurante (nombre, estrellas, direccion, imagen, capacidadMaxima) VALUES
    ('Mundo Milanesa', 3.0, 'Avenida Libertador 789', 'restaurant1.jpg', 100);
SET @idResto2 = LAST_INSERT_ID();

INSERT INTO restaurante (nombre, estrellas, direccion, imagen, capacidadMaxima) VALUES
    ('La Trattoria Bella Italia', 3.0, 'Avenida Libertador 789', 'restaurant2.jpg', 100);
SET @idResto3 = LAST_INSERT_ID();

INSERT INTO restaurante (nombre, estrellas, direccion, imagen, capacidadMaxima) VALUES
    ('La Parrilla de Don Juan', 4.0, 'Avenida Central 456', 'restaurant3.jpg', 100);
SET @idResto4 = LAST_INSERT_ID();

INSERT INTO restaurante (nombre, estrellas, direccion, imagen, capacidadMaxima) VALUES
    ('El Sabor del Mar', 2.0, 'Calle Principal 123', 'restaurant4.jpg', 100);
SET @idResto5 = LAST_INSERT_ID();

INSERT INTO restaurante (nombre, estrellas, direccion, imagen, capacidadMaxima) VALUES
    ('Café Parisien', 4.0, 'Paseo de las Flores 15', 'restaurant5.jpg', 100);
...
INSERT INTO plato (nombre, precio, descripcion, imagen, id_restaurante, id_categoria, esRecomendado) VALUES
                                                                                                         ...
                                                                                                         ('Hamburguesa BBQ', 15500, 'Hamburguesa con carne de res, queso, cebolla caramelizada y salsa BBQ', 'hamburguesa.jpg', @idResto2, @idCategoria2, true),
                                                                                                         ('Hamburguesa BBQ', 15500, 'Hamburguesa con carne de res, queso, cebolla caramelizada y salsa BBQ', 'hamburguesa.jpg', @idResto2, @idCategoria2, true),
                                                                                                         ('Milanesa de Pollo', 17500, 'Milanesa de pollo con ensalada de papas', 'milanesa.jpg', @idResto2, @idCategoria3, true),
                                                                                                         ('Milanesa de Pollo', 17500, 'Milanesa de pollo con ensalada de papas', 'milanesa.jpg', @idResto2, @idCategoria3, true),
                                                                                                         ('Milanesa de Pollo', 17500, 'Milanesa de pollo con ensalada de papas', 'milanesa.jpg', @idResto2, @idCategoria3, true),
...
INSERT INTO plato (nombre, precio, descripcion, imagen, id_restaurante, id_categoria, esRecomendado) VALUES
                                                                                                         ...
                                                                                                         ('Pinchos Morunos', 15000, 'Brochetas de carne de cordero con especias', 'tapas.jpg', @idResto3, @idCategoria6, true),
                                                                                                         ('Gazpacho', 11000, 'Sopa fría de tomate, pepino y pimientos', 'sopa.jpg', @idResto3, @idCategoria7, false),
                                                                                                         ('Risotto de Mariscos', 20500, 'Arroz cremoso con mariscos y azafrán', 'mariscos.jpg', @idResto3, @idCategoria8, true),
                                                                                                         ('Pizza Hawaiana', 14000, 'Pizza con jamón, piña y mozzarella', 'pizza.jpeg', @idResto3, @idCategoria9, true),
                                                                                                         ('Bife de Chorizo', 24000, 'Bife de chorizo a la parrilla con ensalada mixta', 'asado.jpg', @idResto3, @idCategoria10, true);

-- Restaurante 4
INSERT INTO plato (nombre, precio, descripcion, imagen, id_restaurante, id_categoria, esRecomendado) VALUES
                                                                                                         ('Ensalada Caprese', 13000, 'Ensalada de tomate, mozzarella y albahaca', 'ensalada.jpg', @idResto4, @idCategoria1, true),
                                                                                                         ('Hamburguesa con Queso Azul', 16500, 'Hamburguesa con carne de res, queso azul, rúcula y cebolla', 'hamburguesa.jpg', @idResto4, @idCategoria2, true),
                                                                                                         ('Milanesa Suiza', 19000, 'Milanesa de ternera con queso suizo y champiñones', 'milanesa.jpg', @idResto4, @idCategoria3, true),
                                                                                                         ('Flan Casero', 10000, 'Postre de flan con caramelo y crema', 'helado.jpg', @idResto4, @idCategoria4, true),
                                                                                                         ('Lasaña Boloñesa', 17000, 'Lasaña con salsa boloñesa y bechamel', 'pasta.jpeg', @idResto4, @idCategoria5, true),
                                                                                                         ('Montaditos Variados', 15500, 'Pequeños bocados con jamón, chorizo y queso', 'tapas.jpg', @idResto4, @idCategoria6, false),
                                                                                                         ('Sopa Minestrone', 11500, 'Sopa de verduras con pasta y frijoles', 'sopa.jpg', @idResto4, @idCategoria7, true),
                                                                                                         ('Cazuela de Mariscos', 21000, 'Guiso de mariscos con tomate y especias', 'mariscos.jpg', @idResto4, @idCategoria8, true),
                                                                                                         ('Pizza Cuatro Quesos', 14500, 'Pizza con mozzarella, gorgonzola, parmesano y queso de cabra', 'pizza.jpeg', @idResto4, @idCategoria9, true),
                                                                                                         ('Parrillada Mixta', 25000, 'Variedad de carnes a la parrilla con guarniciones', 'asado.jpg', @idResto4, @idCategoria10, true);

-- Restaurante 5
INSERT INTO plato (nombre, precio, descripcion, imagen, id_restaurante, id_categoria, esRecomendado) VALUES
                                                                                                         ('Ensalada de Quinoa', 13500, 'Ensalada de quinoa, vegetales y aderezo de limón', 'ensalada.jpg', @idResto5, @idCategoria1, true),
                                                                                                         ('Hamburguesa Vegetariana', 17000, 'Hamburguesa con medallón de vegetales, queso y aguacate', 'hamburguesa.jpg', @idResto5, @idCategoria2, true),
                                                                                                         ('Milanesa de Pavo', 19500, 'Milanesa de pavo con puré de papas', 'milanesa.jpg', @idResto5, @idCategoria3, true),
                                                                                                         ('Mousse de Chocolate', 10500, 'Postre de mousse de chocolate con crema chantilly', 'helado.jpg', @idResto5, @idCategoria4, true),
                                                                                                         ('Penne a la Arrabiata', 17500, 'Pasta con salsa de tomate picante y ajo', 'pasta.jpeg', @idResto5, @idCategoria5, true),
                                                                                                         ('Croquetas de Jamón', 16000, 'Croquetas fritas de jamón y bechamel', 'tapas.jpg', @idResto5, @idCategoria6, false),
                                                                                                         ('Sopa de Cebolla', 12000, 'Sopa de cebolla gratinada con queso', 'sopa.jpg', @idResto5, @idCategoria7, true),
                                                                                                         ('Pulpo a la Gallega', 21500, 'Pulpo cocido con papas, pimentón y aceite de oliva', 'mariscos.jpg', @idResto5, @idCategoria8, true),
                                                                                                         ('Pizza Calzone', 15000, 'Pizza doblada con relleno de jamón, queso y champiñones', 'pizza.jpeg', @idResto5, @idCategoria9, true),
                                                                                                         ('Cordero Asado', 26000, 'Pierna de cordero asada con papas y romero', 'asado.jpg', @idResto5, @idCategoria10, true);

-- Restaurante 6
INSERT INTO plato (nombre, precio, descripcion, imagen, id_restaurante, id_categoria, esRecomendado) VALUES
                                                                                                         ('Ensalada de Frutas', 14000, 'Ensalada de frutas frescas con yogur', 'ensalada.jpg', @idResto6, @idCategoria1, false),
                                                                                                         ('Hamburguesa Gourmet', 17500, 'Hamburguesa con carne de res, queso brie, rúcula y cebolla caramelizada', 'hamburguesa.jpg', @idResto6, @idCategoria2, true),
