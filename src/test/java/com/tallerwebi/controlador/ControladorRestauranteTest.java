...
public class ControladorRestauranteTest {
    ...
    public void queAlEnviarPromocionSeEnvienLosEmailsCorrectamente() throws Exception {
        ...
        verify(emailMock, times(1)).sendPromotionalEmail("test1@example.com", subject, text);
        verify(emailMock, times(1)).sendPromotionalEmail("test2@example.com", subject, text);
    }
