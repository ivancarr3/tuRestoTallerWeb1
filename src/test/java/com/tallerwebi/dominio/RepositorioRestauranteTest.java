...
public class RepositorioRestauranteTest {
    ...
    public void queGuardeRestauranteCorrectamente() {
        Restaurante restaurante = new Restaurante(1L, "La Quintana", 4.5, "Arieta 5000");
    ...
    public void queActualizeRestaurante() {
        ...
        Restaurante restauranteActualizado = new Restaurante(2L, "Benjamin", 4.0, "Almafuerte 3344");
